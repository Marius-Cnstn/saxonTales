...
CREATE TABLE `army` (
  ...
  PRIMARY KEY (`army_id`),
  KEY `FK7gi4kq4ys6lc54u4c5dnq4hn8` (`warlord_id`),
  CONSTRAINT `FK7gi4kq4ys6lc54u4c5dnq4hn8` FOREIGN KEY (`warlord_id`) REFERENCES `warlord` (`warlord_id`)
