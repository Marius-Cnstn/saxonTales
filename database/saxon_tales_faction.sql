...
CREATE TABLE `faction` (
  ...
  `warlord_id` int DEFAULT NULL,
  PRIMARY KEY (`faction_id`),
  KEY `FKl9sw2vr0kcgeng5ttrt33gm97` (`army_id`),
  KEY `FKf021byrp97hgnjs8j2u1ewog1` (`homestead_id`),
  KEY `FK15tmliqacw03durgofl1ms57k` (`warlord_id`)
...
INSERT INTO `faction` VALUES (1,'House of Wessex',1,1,1);
