...
CREATE TABLE `season_year` (
  `season_year_id` int NOT NULL AUTO_INCREMENT,
  `year` int DEFAULT NULL,
  `season_id` int DEFAULT NULL,
  `season_counter` int DEFAULT NULL,
  PRIMARY KEY (`season_year_id`),
  KEY `FKe5iksjg5xa1h2fffagiv7mnsi` (`season_id`),
  CONSTRAINT `FKe5iksjg5xa1h2fffagiv7mnsi` FOREIGN KEY (`season_id`) REFERENCES `season` (`season_id`)
...
INSERT INTO `season_year` VALUES (1,887,3,3);
